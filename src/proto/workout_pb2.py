...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EXERCISE']._serialized_end=144
  _globals['_WORKOUT']._serialized_start=146
  _globals['_WORKOUT']._serialized_end=244
